...
tokenize(readline) is a generators that breaks a stream of bytes into
...
def detect_encoding(readline):
    ...
    in the same way as the tokenize() generators.
...
def tokenize(readline):
    """
    The tokenize() generators requires one argment, readline, which
    ...
    The generators produces 5-tuples with these members: the token type; the
