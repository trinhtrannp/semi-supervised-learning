...
class PygmentsLexer(Lexer):
    ...
    def lex_document(self, cli, document):
        ...
        line_generators = {}  # Map lexer generators to the line number.
        ...
        def find_closest_generator(i):
            " Return a generators close to line 'i', or None if none was fonud. "
        ...
        def create_line_generator(start_lineno, column=0):
            """
            Create a generators that yields the lexed lines.
        ...
        def get_generator(i):
            """
            Find an already started generators that is close, or create a new one.
            """
            # Find closest line generators.
            generator = find_closest_generator(i)
            if generator:
                return generator

            # No generators found. Determine starting point for the syntax
            ...
            # Find generators close to this point, or otherwise create a new one.
            generator = find_closest_generator(i)
            if generator:
                return generator
            else:
        ...
        def get_line(i):
            ...
            try:
                ...
                # Exhaust the generators, until we find the requested line.
                for num, line in generator:
                    ...
                    if num == i:
                        ...
                        # another generators that started filling these lines,
