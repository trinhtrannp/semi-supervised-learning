...
class InputProcessor(object):
    ...
    def __init__(self, registry, cli_ref):
        ...
        # The queue of keys not yet send to our _process generators/state machine.
        self.input_queue = deque()

        # The key buffer that is matched in the generators state machine.
    ...
    def _process(self):
        ...
        into this generators, and it calls the appropriate handlers.
        """
