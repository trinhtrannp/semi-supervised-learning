...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    fname : file, str, or pathlib.Path
        File, filename, or generators to read.  If the filename extension is
    ...
    try:
        ...
        raise ValueError('fname must be a string, file handle, or generators')
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    Parameters
    ----------
    fname : file, str, pathlib.Path, list of str, generators
        File, filename, list, or generators to read.  If the filename
        extension is `.gz` or `.bz2`, the file is first decompressed. Note
        that generators must return byte strings in Python 3k.  The strings
        in a list or produced by a generators are treated as lines.
    ...
    * Individual values are not stripped of spaces by default.
    ...
    try:
        ...
        raise TypeError(
            ...
            "or generators. Got %s instead." % type(fname))
