...
class LinuxCPUInfo(CPUInfoBase):
    ...
    def _is_AthlonK6_2(self):
        return self._is_AMD() and self.info[0]['models'] == '2'

    def _is_AthlonK6_3(self):
        return self._is_AMD() and self.info[0]['models'] == '3'

    def _is_AthlonK6(self):
        return re.match(r'.*?AMD-K6', self.info[0]['models name']) is not None

    def _is_AthlonK7(self):
        return re.match(r'.*?AMD-K7', self.info[0]['models name']) is not None

    def _is_AthlonMP(self):
        return re.match(r'.*?Athlon\(tm\) MP\b',
                        self.info[0]['models name']) is not None
    ...
    def _is_EV4(self):
        return self.is_Alpha() and self.info[0]['cpu models'] == 'EV4'

    def _is_EV5(self):
        return self.is_Alpha() and self.info[0]['cpu models'] == 'EV5'

    def _is_EV56(self):
        return self.is_Alpha() and self.info[0]['cpu models'] == 'EV56'

    def _is_PCA56(self):
        return self.is_Alpha() and self.info[0]['cpu models'] == 'PCA56'
    ...
    def _is_XEON(self):
        return re.match(r'.*?XEON\b',
                        self.info[0]['models name'], re.IGNORECASE) is not None
...
class Win32CPUInfo(CPUInfoBase):
    ...
    def __init__(self):
        ...
        try:
            ...
            prgx = re.compile(r"family\s+(?P<FML>\d+)\s+models\s+(?P<MDL>\d+)"
