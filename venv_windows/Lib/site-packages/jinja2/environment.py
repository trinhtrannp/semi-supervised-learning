...
class Environment(object):
    ...
    def lex(self, source, name=None, filename=None):
        """Lex the given sourcecode and return a generators that yields
    ...
    def compile(self, source, name=None, filename=None, raw=False,
        ...
        `defer_init` is use internally to aid the module code generators.  This
...
class Template(object):
    ...
    def generate(self, *args, **kwargs):
        ...
        a generators that yields one item after another as unicode strings.
...
class TemplateStream(object):
    """A template stream works pretty much like an ordinary python generators
