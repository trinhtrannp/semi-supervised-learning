...
class FileContentsManager(FileManagerMixin, ContentsManager):
    ...
    post_save_hook = Any(None, config=True, allow_none=True,
        ...
        It will be called as (all arguments passed by keyword)::
            ...
            hook(os_path=os_path, models=models, contents_manager=instance)

        - path: the filesystem path to the file just written
        - models: the models representing the file
    ...
    def _base_model(self, path):
        """Build the common base of a contents models"""
        os_path = self._get_os_path(path)
    ...
    def _dir_model(self, path, content=True):
        """Build a models for a directory
    ...
    def get(self, path, content=True, type=None, format=None):
        """ Takes a path for an entity and returns its models
        ...
        format : str, optional
            ...
            Ignored if this returns a notebook or directory models.

        Returns
        -------
        models : dict
            the contents models. If content=True, returns the contents
    ...
    def save(self, model, path=''):
        """Save the file models and return the models with no content."""
        path = path.strip('/')
