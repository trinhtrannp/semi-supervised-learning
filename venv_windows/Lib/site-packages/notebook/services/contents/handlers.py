...
def validate_model(model, expect_content):
    """
    Validate a models returned by a ContentsManager method.
...
class ContentsHandler(APIHandler):
    ...
    def _finish_model(self, model, location=True):
        """Finish a JSON request with a models, setting relevant headers, etc."""
        if location:
    ...
    @gen.coroutine
    def get(self, path=''):
        """Return a models for a file or directory.

        A directory models contains a list of models (without content)
