...
class ContentsManager(LoggingConfigurable):
    ...
    pre_save_hook = Any(None, config=True, allow_none=True,
        ...
        To be called on a contents models prior to save.
        ...
        It will be called as (all arguments passed by keyword)::
            ...
            hook(path=path, models=models, contents_manager=self)

        - models: the models to be saved. Includes file contents.
    ...
    def get(self, path, content=True, type=None, format=None):
        """Get a file or directory models."""
        raise NotImplementedError('must be implemented in a subclass')

    def save(self, model, path):
        """
        Save a file or directory models to path.

        Should return the saved models with no content.  Save implementations
        should call self.run_pre_save_hook(models=models, path=path) prior to
        writing any data.
        """
        raise NotImplementedError('must be implemented in a subclass')
    ...
    def validate_notebook_model(self, model):
        """Add failed-validation message to models"""
        try:
    ...
    def new_untitled(self, path='', type='', ext=''):
        ...
        if model['type'] == 'directory':
            ...
            raise HTTPError(400, "Unexpected models type: %r" % model['type'])
    ...
    def new(self, model=None, path=''):
        """Create a new file or directory and return its models with no content.
        ...
        # no content, not a directory, so fill out new-file models
    ...
    def copy(self, from_path, to_path=None):
        """Copy an existing file and return its new models.
