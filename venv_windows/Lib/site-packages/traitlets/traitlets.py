...
def default(name):
    ...
    ::
        ...
        class B(A):
            bar = Float()  # This trait ignores the default generators defined in
                           # the base class A
        ...
        class C(B):
            ...
            @default('bar')
            def some_other_default(self):  # This default generators should not be
...
class UseEnum(TraitType):
    """Use a Enum class as models for the data type description.
