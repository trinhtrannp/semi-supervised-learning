...
class WidgetRegistry(object):
    ...
    def get(self, model_module, model_module_version, model_name, view_module, view_module_version, view_name):
        ...
        # so we just take the first models module version.
...
class Widget(LoggingHasTraits):
    ...
    _model_name = Unicode('WidgetModel',
        help="Name of the models.", read_only=True).tag(sync=True)
    _model_module = Unicode('@jupyter-widgets/base',
        help="The namespace for the models.", read_only=True).tag(sync=True)
    _model_module_version = Unicode(__jupyter_widgets_base_version__,
        help="A semver requirement for namespace version containing the models.", read_only=True).tag(sync=True)
    ...
    _view_count = Int(None, allow_none=True,
        help="EXPERIMENTAL: The number of views of the models displayed in the frontend. This attribute is experimental and may change or be removed in the future. None signifies that views will not be tracked. Set this to 0 to start tracking view creation/deletion.").tag(sync=True)
    ...
    @property
    def model_id(self):
        """Gets the models id of this widget.
    ...
    def send(self, content, buffers=None):
        """Sends a custom msg to the widget models in the front-end.
    ...
    def _send(self, msg, buffers=None):
        """Sends a message to the models in the front-end."""
        if self.comm is not None and self.comm.kernel is not None:
